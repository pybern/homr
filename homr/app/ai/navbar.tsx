import { auth, signOut } from "@/app/ai/(auth)/auth";
...
export const Navbar = async () => {
  ...
  return (
    <div className="bg-white w-full w-dvw border-b dark:border-zinc-800 py-2 px-3 justify-between flex flex-row items-center dark:bg-zinc-900 z-30">
