...
const criticalDates: CriticalDate[] = [
  {
    ...
    date: "2025-03-15",
    description: "Annual review of client service agreement",
  },
  {
    id: 2,
    type: "Debt Collection",
    date: "2025-04-30",
    description: "Follow up on outstanding invoices over 90 days",
  },
  {
    id: 3,
    type: "Renewal Option",
    date: "2025-06-01",
    description: "Decision deadline for extending office lease",
  },
  {
    id: 4,
    type: "Tax Filing",
      ...
      <SidebarInset>
        ...
        <div className="flex flex-1 flex-col gap-4 p-4 pt-0">
          <div className="grid gap-4 md:grid-cols-3">
            ...
            <Card>
              <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                <CardTitle className="text-sm font-medium">Annual Rent Expense</CardTitle>
